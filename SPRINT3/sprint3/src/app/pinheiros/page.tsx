...
const Pinheiros = () => {
  return (
    <>
      <div>
        <h1 className="text-[2.2rem] lg:text-3xl w-[88%] lg:w-[22%] mx-auto font-semibold text-center mb-6">
        ...
        <p className="bg-[#42807D] text-center text-white w-[77%] lg:w-[30%] p-2 text-[1.3rem] lg:text-[1.5rem] mx-auto">
          Operando normalmente
        </p>

        <p className="font-bold text-center m-8 text-[1.4rem]">Lotação</p>
        <div className="flex w-[77%] lg:w-[20%] mb-[60px] mx-auto justify-center gap-2">
        ...
        <div className="bg-[#42807D] text-white w-[77%] lg:w-[30%] text-center mx-auto p-4 rounded-2xl">
          <h2 className="font-bold">Relatório</h2>
          <p>24/10/24</p>
          <ul className="flex flex-col gap-2 text-[1.2rem] mt-4 mb-4">
            <li>
        ...
        <div className="mt-[60px] mx-auto">
          <Link href="/esmeralda">
            <button className="bg-green-400 text-white p-4 cursor-pointer lg:text-2xl mx-auto rounded-2xl w-[20%]">
              Voltar
            </button>
          </Link>
        </div>
