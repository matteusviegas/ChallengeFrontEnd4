            ...
            <main>
                ...
                <div className='mt-44 pl-14'>
                    <div className="ml-8 text-2xl">
                        <div className="w-full md:w-[70%]"> {/* Ajustado para ser full width em dispositivos móveis */}
                            <h1 className='text-[2.9rem] pb-[4%] font-bold'>Solução e funcionalidades</h1>
                            ...
                            <p className="text-[2rem] pt-[7%]"><strong>Análise de Horários de Pico:</strong>Lorem ipsum dolor sit amet consectetur adipisicing elit. Quasi soluta ipsa ut accusamus nemo optio, officiis, sit est esse quaerat fugit odit quibusdam quisquam omnis hic facere doloribus placeat praesentium!</p>
                        </div>

                        <h2 className="text-5xl pt-[7%]">Nossa visão</h2>
                        <div>
                            <p className="pt-14 text-[2rem] w-full md:w-[70%]">Ser a plataforma líder em soluções de automação interativa e gestão inteligente de dados, melhorando a eficiência e a comunicação em ambientes corporativos e educacionais</p>
                        </div>

                        <h2 className="text-5xl pt-[6%]">Nossa Missão</h2>
                        <div>
                            <p className="pt-14 text-[2rem] w-full md:w-[65%]">Proporcionar uma experiência fluida e personalizada através de soluções tecnológicas avançadas, promovendo a agilidade, a inovação e o acesso rápido à informação. Essa abordagem da Future Station visa transformar a maneira como as organizações se comunicam e gerenciam suas operações.</p>
                        </div>
                    </div>
